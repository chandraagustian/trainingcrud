...
<?php $__env->startSection("content"); ?>
  ...
  <div class="row">
    ...
    <?php echo link_to(route("articles.create"), "Export", ["class"=>"pull-right btn btn-raised btn-primary"]); ?>

    <?php echo link_to(route("imports.create"), "Import", ["class"=>"pull-right btn btn-raised btn-primary"]); ?>
